    ...
    <div style="margin: 40px 0;">
        ...
        <div style="margin: 20px 0;">
            ...
            <div style="border: 1px solid rgba(0,0,0,.1); padding: 10px; margin-top: 10px;">
                <div>[featured-projects][/featured-projects]</div>
                <div>[properties-by-locations][/properties-by-locations]</div>
                <div>[properties-for-sale][/properties-for-sale]</div>
                <div>[properties-for-rent][/properties-for-rent]</div>
                <div>[featured-agents title="Featured Agents"][/featured-agents]</div>
                ...
                <div>[latest-news][/latest-news]</div>
            </div>
            <br>
...
<?php /**PATH D:\wamp64\www\immo\platform/themes/flex-home/views/index.blade.php ENDPATH**/ ?>