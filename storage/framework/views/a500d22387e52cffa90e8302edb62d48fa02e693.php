                ...
                <?php if(Arr::get($group, 'items')): ?>
                    <li class="admin-bar-dropdown">
                        ...
                        <ul class="admin-bar-dropdown-menu">
                            <?php $__currentLoopData = Arr::get($group, 'items', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
...
<?php /**PATH D:\wamp64\www\immo\platform/packages/theme/resources/views//admin-bar.blade.php ENDPATH**/ ?>