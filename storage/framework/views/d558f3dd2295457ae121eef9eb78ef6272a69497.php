                ...
                <div class="page-sidebar navbar-collapse collapse">
                    <div class="sidebar">
                        <div class="sidebar-content">
                            <ul class="page-sidebar-menu page-header-fixed <?php echo e(session()->get('sidebar-menu-toggle') ? 'page-sidebar-menu-closed' : ''); ?>" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
...
<?php echo $__env->make('core/base::layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\immo\platform/core/base/resources/views//layouts/master.blade.php ENDPATH**/ ?>